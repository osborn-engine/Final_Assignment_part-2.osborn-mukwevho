...
@app.callback(
    ...
    [Input(component_id='dropdown-statistics', component_property='value'), Input(component_id='dropdown-statistics', component_property='value')])
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Average Automobile Sales for each Vehicle Type in the Recession Perion"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].su
        um().reset_index()
        R_chart4 = dcc.Graph(figure=px.bar(unemp_type-sales,
        x='unemployment_rate',
        y='Automobile_Sales',
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp.exp_data,
        values='Advertising_Expenditure',
        names='Vehicle_Type',
